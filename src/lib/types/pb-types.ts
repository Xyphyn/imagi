...
export type BlogResponse<Texpand = unknown> = BlogRecord &
...
export type CommunitiesResponse<Texpand = unknown> = CommunitiesRecord &
    BaseSystemFields<Texpand>
export type CommunityCountsResponse<Texpand = unknown> = CommunityCountsRecord &
    BaseSystemFields<Texpand>
export type CountsResponse<Texpand = unknown> = CountsRecord &
    BaseSystemFields<Texpand>
export type LikesResponse<Texpand = unknown> = LikesRecord &
    BaseSystemFields<Texpand>
export type PostCountsResponse<Texpand = unknown> = PostCountsRecord &
    BaseSystemFields<Texpand>
export type PostsResponse<Texpand = unknown> = PostsRecord &
    BaseSystemFields<Texpand>
export type ReportsResponse<Texpand = unknown> = ReportsRecord &
    BaseSystemFields<Texpand>
